 ...
 * Notes
 * 
 	On the exam, be wary of any local variable that is declared but not initialized
	in a single line. This is a common place on the exam that could result
...
public class InitializingVariables {
	...
	public static void main(String[] args) {
		...
		/*Defining Instance and Class Variables
		 ...
		 An instance variable, often called a field, is a value defined within a specific
		...
		A variable is a class variable if it has the "static" keyword
		in its declaration!!!
